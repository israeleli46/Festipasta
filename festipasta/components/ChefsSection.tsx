...
import Partner from "./PartnersSection"; // Assuming you have a PartnersSection component
    ...
    <section id="chefs" className="py-20 bg-festival-grey-light">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-foreground px-auto">
           Nos Partenaires
          </h2>
          <p className="text-lg text-festival-grey max-w-3xl mx-auto">
            ...
            d'accueillir des chfs de renommée sous regionnale, apportant avec eux une richesse de saveurs et d'expertises.
          </p>
        </div>

        <div className="grid lg:grid-cols-1 h-full overflow-x-hidden items-center justify-around mb-3 md:pb-15 md:h-full sm:block sm:grid-cols-2 sm:gap-6">
          <div className="relative ">
            ...
            /> */}
            <Partner/>
            {/* <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent rounded-2xl justify-between"></div>
          ...
          {/* <div className="grid sm:grid-cols-2 gap-6 ml-3">
