...
const Partner=() => {
  return (
    ...
    // je dois regarder la class de reservation colorer pour gerer la responsivité ici
    <div className="flex flex-row w-full h-auto space-x-2 mx-3 items-center justify-between gap-8 sm:flex-row">
      <img  src="/pic3.jpeg" className="w-20 sm:w-40 md:w-60 lg:w-60 object-cover" />
      <img  src="/pic2.jpeg" className="w-20 sm:w-40 md:w-60 lg:w-60 object-cover" />
      <img  src="/pic5.jpeg" className="w-20 sm:w-40 md:w-60 lg:w-60 object-cover" />
